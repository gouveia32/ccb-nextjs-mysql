...
import AddNote, { AddNoteProps } from "./add-patient.component";
...
import {
  ...
  AddNoteInputTag,
} from "./add-patient.styles";
import { CheckPointObject } from "../../models/CheckPointObject";
import NoteCheckItem from "./AddPatientCheckItem/add-patient-checkitem.component";
